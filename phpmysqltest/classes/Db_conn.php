...
class DatabaseConn {	
  ...
  public function dbOpen(){
    ...
    try {
      ...
      $dbHost = 'localhost';
      $dbName = 'kabelcher';//this will be your WCC username
      $dbUsr = 'kabelcher';//this will be your WCC username
      $dbPass = 'fwF6QFWY5uFX';//this will be the password found in the video.
